                                        ...
                                        <form action="{{ route('hotels.index') }}" method="get">
                                            <div class="row justify-content-end align-items-center">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    @if (auth()->user()->hasPermission('create_hotels'))
                            ...
                            @if ($finalResults->count() > 0)
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th>@lang('site.sitelink')</th>
                                        <th>@lang('site.stars')</th>
                                        @if (auth()->user()->hasPermission('update_hotels','delete_hotels'))
                                    ...
                                    @foreach ($finalResults as $index=>$row)
                                        <tr>
                                            ...
                                            <td>
                                                {{$row->stars}} <i class="fas fa-star ml-2"></i>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                {{--                                                @endif--}}
                                                @if (auth()->user()->hasPermission('update_hotels'))
                                                    <a href="{{ route('hotels.edit', $row->id) }}"
                                                ...
                                                @endif
                                                @if (auth()->user()->hasPermission('delete_hotels'))
                                                    <form action="{{ route('hotels.destroy', $row->id) }}" method="post"
