                                            ...
                                            <div class="card-body">
                                                ...
                                                @if($locale == 'en')
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="banner_alt"
                                                                       class="form-control"
                                                                       value="{{ $category->photos->banner_alt }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="thumb_alt" class="form-control"
                                                                       value="{{ $category->photos->thumb_alt}}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!--  Images Preview --->
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <img
                                                                src="{{asset('uploads/'.$category->photos->banner_url)}}"
                                                                width="150px"
                                                                height="150px"
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <img
                                                                src="{{asset('uploads/'.$category->photos->thumb_url)}}"
                                                                width="150px"
                                                                height="150px"
                                                ...
                                                <div class=" from-group">
                                                    ...
                                                    <input type=" text" name="{{ $locale }}[page_title]"
                                                           class="form-control"
                                                           value="{{ $category->seoAttributes->translate($locale)->page_title }}">
                                                </div>
                                                <div class="form-group">
                                                    @if(count(config('translatable.locales'))>1)
                                                    ...
                                                    <textarea name="{{ $locale }}[meta_description]"
                                                              class="form-control ckeditor"> {{ $category->seoAttributes->translate($locale)->meta_description }}"</textarea>
                                                </div>
                                                <div class="form-group">
                                                    @if(count(config('translatable.locales'))>1)
                                                    ...
                                                    <textarea name="{{ $locale }}[og_description]"
                                                              class="form-control ckeditor"> {{ $category->seoAttributes->translate($locale)->og_description }}"</textarea>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="{{ $locale }}[og_title]"
                                                                   class="form-control "
                                                                   value="{{ $category->seoAttributes->translate($locale)->og_title }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="{{ $locale }}[meta_keywords]"
                                                           ...
                                                           type="text"
                                                           class="form-control"
                                                           value="{{  $category->seoAttributes->translate($locale)->meta_keywords }}">
