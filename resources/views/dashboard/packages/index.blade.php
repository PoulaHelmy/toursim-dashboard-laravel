    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('packages.index') }}"> @lang('site.packages')</a>
                </li>
            </ol>
        </section>
                            ...
                            <div class="card-header">
                                <div class="row justify-content-between align-items-center">
                                    <div class="col-12 col-md-4">
                                        <h3 class="card-title {{ app()->getLocale() == 'ar' ? 'float-left text-right' : '' }}">@lang('site.packages')</h3>
                                    </div>
                            ...
                            @if ($finalResults->count() > 0)
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        @if (auth()->user()->hasPermission('update_packages','delete_packages'))
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if (auth()->user()->hasPermission('delete_packages'))
                                                    <form action="{{ route('packages.destroy', $row->id) }}"
                                                          method="post"
